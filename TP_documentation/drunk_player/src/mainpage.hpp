...
///
///
/// - d'une bibliothèque (drunk_player) contenant le code de base</li>
/// - d'un programme graphique (drunk_player_gui) qui affiche le résultat à l'écran</li>
/// - d'un programme console (drunk_player_cli) qui sort le résultat dans un fichier</li>
///
